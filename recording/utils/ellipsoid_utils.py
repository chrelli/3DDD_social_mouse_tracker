...
from utils.fitting_utils import mouse_body_geometry
...
def Algebraic_Separation_Condition(coeff_i,r_i,A_i,coeff_j,r_j,A_j):
    ...
    if len(negative_roots_ids) == 2:
        ...
        # print('Separation Condition: quadric surfaces are not separated (they are overlapping).')
        return False
...
from utils.fitting_utils import add_mouse_for_video,open_3d,close_3d
...
def check_mice_for_overlap(x0):
    ...
    # nose2nose, the separation criterion is true if they are separated
    # hence the ~
    n2n = not Algebraic_Separation_Condition(nose_pack_0[0],nose_pack_0[1],nose_pack_0[2],
                                            nose_pack_1[0],nose_pack_1[1],nose_pack_1[2])
    h2h = not Algebraic_Separation_Condition(hip_pack_0[0],hip_pack_0[1],hip_pack_0[2],
                                                hip_pack_1[0],hip_pack_1[1],hip_pack_1[2])

    # have the nose first
    n2h_0 = not Algebraic_Separation_Condition(nose_pack_0[0],nose_pack_0[1],nose_pack_0[2],
                                            hip_pack_1[0],hip_pack_1[1],hip_pack_1[2])
    n2h_1 = not Algebraic_Separation_Condition(nose_pack_1[0],nose_pack_1[1],nose_pack_1[2],
