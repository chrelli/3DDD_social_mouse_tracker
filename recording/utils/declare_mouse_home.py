...
def mouse_body_size_constants(body_scale = 1,use_old=False):
    ...
    a_hip_max = 0.08/2 #m
    b_hip_min = 0.038/2 #m
    b_hip_max = 0.046/2 #m, was 0.046, which was too much
    d_hip = 0.019 #m
...
plot_tracking(tracking_holder[:,0:50],hard_lo,hard_hi)
...
def run_video(tracking_holder,start_frame,top_folder,n_frames=None,decimate = 10,export = False):
